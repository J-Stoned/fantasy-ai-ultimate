// Fixed pattern queries for your actual schema - VERSION 2
// Fixes: status = 'STATUS_FINAL', start_time is TEXT, proper column names
  ...
  revengeGame: `
    WITH matchups AS (
      ...
      JOIN games g2 ON 
        ...
        AND g2.status = 'STATUS_FINAL'
      WHERE g1.status = 'STATUS_FINAL'
    )
