...
Write-Host ""
Write-Host "Creating fantasy_ai_local database..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "Your Ryzen 5 7600X is ready for BLAZING FAST queries!" -ForegroundColor Magenta