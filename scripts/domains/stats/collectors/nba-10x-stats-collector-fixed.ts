#!/usr/bin/env tsx
/**
 * 🏀 NBA 10X STATS COLLECTOR - FIXED
 * 
 * Fixed to handle 14-element stat arrays
...
async function collectNBAStats() {
  console.log(chalk.bold.cyan('🏀 NBA 10X STATS COLLECTOR - FIXED\n'));
                  ...
                  for (const athlete of statGroup.athletes || []) {
                    ...
                    batchStats.push({
                      ...
                      metadata: {
                        ...
                        collection_source: 'nba-10x-stats-fixed'
                      }
                    });
                  }
                }
  ...
  console.log(chalk.green(`  Games with stats: ${uniqueGameCount}/1322`));
