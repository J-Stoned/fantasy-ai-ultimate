#!/usr/bin/env tsx
/**
 * 🏀 NBA STATS COLLECTOR - Yahoo Fantasy Scoring with DEDUPLICATION
...
console.log(chalk.bold.cyan('🏀 NBA STATS COLLECTOR - Yahoo Fantasy Scoring (Daily-Ready)\n'));
...
async function collectNBAStats() {
  console.log('🚀 STARTING NBA STATS COLLECTION (DAILY-READY VERSION)');
