#!/usr/bin/env tsx
/**
 * 🏀 NBA STATS COLLECTOR - COMPLETE COLLECTION
 * Collects stats for ALL games that don't have them yet
 */
...
console.log(chalk.bold.yellow('🏀 NBA STATS COLLECTOR - COMPLETE COLLECTION\n'));
...
async function collectNBAStats() {
  ...
  if ((finalTotal || 0) >= 15000) {
    console.log('\n🎯 SUCCESS! 15K+ stats target achieved!');
  }
}
