...
async function collectNHL2024StatsFast() {
    console.log('🏒 NHL 2024-25 STATS COLLECTOR (FAST MODE)');
    console.log('==========================================\n');

    try {
        // Get all NHL 2024-25 games with pagination
        let allGames: any[] = [];
        let offset = 0;
        const limit = 1000;
        ...
        console.log(`Found ${allGames.length} NHL 2024-25 games\n`);
        ...
        console.log(`\nTotal NHL 2024-25 logs in database: ${count}`);
