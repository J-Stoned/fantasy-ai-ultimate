...
export default function PredictionsScreen() {
  ...
  const loadPredictions = async () => {
    try {
      ...
      // TODO: Replace with real ML predictions API call
      // For now, use base projections without fake randomization
      const transformedPredictions = (players || []).map(player => {
        const predictedPoints = player.projected_points || 0;
        ...
        return {
          ...
          predictedPoints,
          confidence: 0, // Will be set by real ML model
          trend: 'stable', // Will be calculated by real ML model
          insights: [], // Will be generated by real ML model
          aiModelVersion: 0, // No model yet
          aiAccuracy: 0, // No accuracy yet
        };
      });

      setPredictions(transformedPredictions);
      setModelInfo(null); // No ML model connected yet
    } catch (error) {
