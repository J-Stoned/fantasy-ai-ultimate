...
-- This maintains compatibility while adding needed functionality
...
CREATE TABLE IF NOT EXISTS player_platform_mapping (
  ...
  platform VARCHAR(50) NOT NULL, -- 'espn', 'balldontlie', 'sportsdata'
...
CREATE TABLE IF NOT EXISTS player_game_logs (
  ...
  stats JSONB NOT NULL DEFAULT '{}', -- Flexible stats storage
...
CREATE TABLE IF NOT EXISTS player_season_stats (
  ...
  season_type VARCHAR(20) DEFAULT 'regular', -- regular, playoffs, preseason
  team_id INTEGER REFERENCES teams(id),
  games_played INTEGER DEFAULT 0,
  stats JSONB NOT NULL DEFAULT '{}', -- Aggregated season stats
  created_at TIMESTAMPTZ DEFAULT NOW(),
  updated_at TIMESTAMPTZ DEFAULT NOW(),
...
-- 10. Create search function for players
