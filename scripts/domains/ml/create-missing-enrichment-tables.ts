#!/usr/bin/env tsx
/**
 * Create missing enrichment tables for 100% completeness
 */
...
async function createEnrichmentTables() {
  ...
  try {
    ...
    `);
    console.log(chalk.green('✅ weather_data table created'));
