-- Comprehensive Stat Definitions for All Sports
-- This populates the stat_definitions table with 500+ micro-analytics

-- Use INSERT ... ON CONFLICT to handle existing data
-- This will update existing stats and insert new ones
...
('NFL', 'passing_advanced', 'red_zone_touchdowns', 'RZ TDs', 'Red zone passing TDs', 'count', 9, true, false),
...
('NFL', 'rushing_advanced', 'red_zone_touchdowns', 'RZ TDs', 'Red zone rushing TDs', 'count', 9, true, false);
...
INSERT INTO stat_definitions (sport, stat_category, stat_name, display_name, description, unit, importance_score, fantasy_relevance, requires_tracking_data) VALUES
('NFL', 'receiving_advanced', 'average_depth_of_target', 'aDOT', 'Average depth of target', 'distance', 7, false, true),
('NFL', 'receiving_advanced', 'air_yards', 'Air Yards', 'Receiving air yards', 'count', 7, true, true),
('NFL', 'receiving_advanced', 'yards_after_catch', 'YAC', 'Yards after catch', 'count', 8, true, true),
...
('NFL', 'receiving_advanced', 'red_zone_touchdowns', 'RZ TDs', 'Red zone receiving TDs', 'count', 9, true, false);
...
-- =====================================================
-- SOCCER STATS (MLS, Premier League, etc.)
-- =====================================================
...
ALTER TABLE stat_definitions ADD CONSTRAINT unique_sport_stat UNIQUE (sport, stat_name);
...
CREATE INDEX IF NOT EXISTS idx_stat_def_importance ON stat_definitions(importance_score DESC);
CREATE INDEX IF NOT EXISTS idx_stat_def_fantasy ON stat_definitions(fantasy_relevance) WHERE fantasy_relevance = true;