-- Fixed NCAA Stats Insert (no duplicates)
-- This version ensures unique stat_names per sport
...
('NCAA_FB', 'passing', 'passing_interceptions', 'Pass INTs', 'Interceptions thrown', 'count', 8, true),  -- Changed name
...
('NCAA_FB', 'defense', 'defensive_interceptions', 'Def INTs', 'Defensive interceptions', 'count', 9, true),  -- Changed name
...
-- Show all sports summary
SELECT 
  'All Sports Summary:' as status,
  sport, 
  COUNT(*) as stat_count 
FROM stat_definitions 
GROUP BY sport
