...
-- Run this SQL to prepare database for MiLB data collection
...
-- Add sports for MiLB levels
INSERT INTO sports (id, name, sport_type) VALUES 
  (gen_random_uuid(), 'Minor League Baseball - Triple-A', 'baseball'),
  (gen_random_uuid(), 'Minor League Baseball - Double-A', 'baseball'),
  (gen_random_uuid(), 'Minor League Baseball - High-A', 'baseball'),
  (gen_random_uuid(), 'Minor League Baseball - Single-A', 'baseball'),
  (gen_random_uuid(), 'Minor League Baseball - Rookie', 'baseball')
