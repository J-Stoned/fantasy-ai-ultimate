#!/usr/bin/env tsx
/**
 * 🏒 NHL STATS COLLECTOR - Yahoo Fantasy Scoring with DEDUPLICATION
...
console.log(chalk.bold.blue('🏒 NHL STATS COLLECTOR - Yahoo Fantasy Scoring (Daily-Ready)\n'));
...
const CONFIG = {
  ...
  DAYS_BACK: process.env.NHL_DAYS_BACK ? parseInt(process.env.NHL_DAYS_BACK) : null
};
...
async function collectNHLStats() {
  console.log('🚀 STARTING NHL STATS COLLECTION (DAILY-READY VERSION)');
