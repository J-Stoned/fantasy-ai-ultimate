/**
 * Stats Worker - JavaScript version for Worker threads
 * This file is auto-generated from stats-worker.ts
 */
...
class InMemoryCache {
  constructor() {
    ...
    this.gamesByExternalId = new Map();
  }
...
async function processGames(games, sport, year) {
  const stats = [];
  let processed = 0;
...
function transformStats(statValues, statNames, sport) {
  const stats = {};
...
function calculateFantasyPoints(stats, sport) {
  let points = 0;
